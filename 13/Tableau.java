...
public class Tableau {
    ...
    public void addValue(Integer value) {
      ...
      if(smallest == null){
        ...
        Cell workingCell = smallest;
        Integer  popped = addToRow(workingCell, value);
        ...
        if(popped == null){
          ...
          while(popped != null){
            ...
            if(workingCell.below == null){
              Cell newRow = new Cell(popped);
              newRow.above = workingCell;
              workingCell.below = newRow;
              newRow.left = null;
              newRow.right = null;
              return;
              
            }else{
              workingCell = workingCell.below;
              popped = addToRow(workingCell, popped);
            }
          }
        }
      }
      ...
      while(curr.value < value){
          if(curr.right == null){
              ...
              if(curr.above != null){
                  ...
                  curr.above.right.below = endCell;
                  endCell.above = curr.above.right;
                  }
              }
              if(curr.below != null){
                  if(curr.below.right != null){
                      curr.below.right.above = endCell;
                      endCell.below = curr.below.right;
                  }
              }
              return null;
          } else {
